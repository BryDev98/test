...
const products = [
{ id: "tamal-habanero", name: "Tamal Habanero", category: "Entrantes", price: 15, description: "Tamal cubano casero, suave y bien sazonado.", icon: "🫔", favorite: false, available: true },
{ id: "arroz-imperial", name: "Arroz Imperial", category: "Platos fuertes", price: 25, description: "Arroz cremoso por capas, pollo sazonado, mayonesa y queso gratinado.", icon: "🍚", favorite: true, available: true },
{ id: "lasagna-carne", name: "Lasagna de Carne", category: "Platos fuertes", price: 20, description: "Capas generosas de pasta, carne sazonada, salsa y queso gratinado.", icon: "🍝", favorite: true, available: true },
{ id: "bistec-encebollado", name: "Bistec Encebollado", category: "Platos fuertes", price: 27, description: "Bistec jugoso con abundante cebolla dorada y sazón casera.", icon: "🥩", favorite: true, available: true },
{ id: "pollo-rostizado", name: "Pollo Rostizado", category: "Platos fuertes", price: 25, description: "Pollo marinado, dorado por fuera y jugoso por dentro.", icon: "🍗", favorite: false, available: true },
{ id: "asado-cerdo", name: "Asado de Cerdo en Cazuela", category: "Platos fuertes", price: 27, description: "Cerdo tierno cocinado lentamente con salsa criolla.", icon: "🍖", favorite: false, available: true },
{ id: "flan-abuela", name: "Flan de la Abuela", category: "Dulces", price: 7, description: "Flan cremoso de receta tradicional con caramelo.", icon: "🍮", favorite: false, available: true },
{ id: "arroz-leche", name: "Arroz con Leche y Lluvia de Chocolate", category: "Dulces", price: 10, description: "Arroz con leche cremoso terminado con una lluvia de chocolate.", icon: "🍫", favorite: false, available: true },
];
...
<div class="favorite-art" data-icon="${product.icon}"></div>
...
favoritesList.innerHTML = products.filter((p) => p.favorite).map(favoriteCard).join("");
}
function renderMenu(filter = "all") {
const filtered = products.filter((p) => p.available && (filter === "all" || p.category === filter));
